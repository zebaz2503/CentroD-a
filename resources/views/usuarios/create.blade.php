...
<h1>FORMULARIO DE INSCRIPCIÓN CENTRO DIA O VIDA</h1>
<br/>
<center>
    ...
    <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    value="{{ isset($usuario->primer_nombre)?$usuario->primer_nombre:old('primer_nombre')}}">
            ...
            <!--<div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control {{$errors->has('segundo_nombre')? 'is-invalid':'' }}" name="segundo_nombre" id="segundo_nombre" 
                    value="{{ isset($usuario->segundo_nombre)?$usuario->segundo_nombre:old('segundo_nombre')}}">
            ...
            <!--<div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control {{$errors->has('segundo_apellido')? 'is-invalid':'' }}" name="segundo_apellido" id="segundo_apellido" 
                    value="{{ isset($usuario->segundo_apellido)?$usuario->segundo_apellido:old('segundo apellido')}}">
